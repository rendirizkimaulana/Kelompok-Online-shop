...
<head>
    ...
    <link href="{{ asset('assets_admin/compiled/css/app.css') }}" rel="stylesheet">
    <link href="{{ asset('assets_admin/compiled/css/app-dark.css') }}" rel="stylesheet">
    <link href="{{ asset('assets_admin/extensions/datatables.net-bs5/css/dataTables.bootstrap5.min.css') }}"
        rel="stylesheet">
    ...
    <script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js"
        data-client-key="SB-Mid-client-UgfbsUN5JJq1CeET"></script>
...
<body>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item ">
                            <a href="{{ route('index.admin') }}" class='sidebar-link'>
                        ...
                        <li class="sidebar-item ">
                            <a href="{{ url('admin/kontem') }}" class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
                                <span>Konten</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-item ">
                            <a class="btn btn-secondary mx-1" href="{{ route('logout') }}"
    ...
    <script src="{{asset('assets_admin/static/js/components/dark.js')}}"></script>
    <script src="{{asset("assets_admin/extensions/perfect-scrollbar/perfect-scrollbar.min.j")}}s"></script>
    <script src="{{asset('assets_admin/extensions/jquery/jquery.min.js')}}"></script>
    <script src="{{asset('assets_admin/extensions/datatables.net/js/jquery.dataTables.min.js')}}"></script>
    <script src="{{asset('assets_admin/extensions/datatables.net-bs5/js/dataTables.bootstrap5.min.js')}}"></script>
    <script src="{{asset('assets_admin/static/js/pages/datatables.js')}}"></script>
